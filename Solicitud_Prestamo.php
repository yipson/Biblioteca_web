...
<body>
    ...
    <div class="container">
        ...
        <section class="banner">
            ...
            <p class="tagline">Ingrese la información del Usuario que desea registrar</p>
            ...
            <div>
				<form action="registro_prestamo.php" method="post">
                    ...
                    <label for="fname">Multa mayor a diez días</label>
                    ...
                    <label for="fname">Fecha de Devolución</label>
