                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a name ="id" id="id" href="editarEDIT.php?id=<?php echo $filas ['id_edit'] ?>">Editar</a>
                                <a name ="id" id="id" href="eliminarEDIT.php?id=<?php echo $filas ['id_edit'] ?>">Eliminar</a>
                            </td>
                            <?php } ?> 
                        </tr>    
                  <?php } ?>
